...
export default function FromaddCustomer({onClose,isAdding, setIsAdding,selectedProduct}) {
    ...
    const handleSubmit=async (event)=>{
        ...
        var res = await axios.post('https://localhost:7084/api/Customers',inputvalue)
        console.log(res)
        if(res.status === 201){
